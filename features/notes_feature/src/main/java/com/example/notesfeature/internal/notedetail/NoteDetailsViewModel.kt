...
internal class NoteDetailsViewModel(noteService: NoteService, analytics: Analytics, noteId: Int) :
    ViewModel() {
    ...
    class Factory(private val noteService: NoteService, private val analytics: Analytics, private
    val noteId: Int) :
